...
I am honestly grateful that you've constantly taken the time out to spare your time and assist us first years. You truly deserve an award for your efforts. We appreciate your help and dedication and wish you a happy Corona free birthday XD. 
<br>-Jevon Forrest`,
...
function birthdayMessage(pName) {
  ...
  if (window.innerWidth >= 400) {
    personalMessage.style.clipPath = "circle(50%)";
    personalMessage.style.zIndex = "1";
  }
...
document.getElementById("backBtn").onclick = function() {
  ...
  if (window.innerWidth >= 400) {
    personalMessage.style.clipPath = "circle(0%)";
    personalMessage.style.zIndex = "-1";
  }
